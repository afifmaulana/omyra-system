    ...
    <div class="box-shadow">
        <div class="col-12 shadow shadow-lg">
            ...
            <div class="row justify-content-center">
                <div class="text-header font-size-18 text-active-pink font-weight-500">Data Barang Jadi</div>
            </div>
        </div>
    </div>
    <div class="bg-grey pt-23 mt-1" style="max-height: 86vh; overflow: scroll;">
        <div class="container-omyra" style="margin-bottom: 90px;">
            ...
            <div class="float-right">
                <a href="{{ route('frontend.finished.create') }}" class="btn btn-sm btn-primary"
...
<script>
    ...
    if ($('#dataTable').length) {
        let url = "{{ route('frontend.finished.datatables') }}";
        let rowData = [{
                data: 'id',
                name: 'id'
            },
    ...
    $(document).on('click', '.btn-delete', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ url('/briquette/finished/delete') }}" + "/" + id,
                    data: {
                        // "_token": "{{ csrf_token() }}"
                    },
                    cache: false,
