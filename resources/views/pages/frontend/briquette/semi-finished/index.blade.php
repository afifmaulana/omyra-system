    ...
    <div class="bg-grey pt-23 mt-1" style="max-height: 86vh; overflow: scroll;">
        <div class="container-omyra" style="margin-bottom: 90px;">
            ...
            <div class="float-right">
                <a href="{{ route('frontend.semi-finished.create') }}" class="btn btn-sm btn-primary"
...
@push('scripts')
    ...
    <script>
        ...
        if ($('#dataTable').length) {
            let url = "{{ route('frontend.semi-finished.datatables') }}";
            let rowData = [{
                    data: 'id',
                    name: 'id'
                },
            ...
            table = $("#dataTable").DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.oven_date = $('input[name=oven_date]').val()
        ...
        $(document).on('click', '.btn-delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "{{ url('/briquette/semi-finished/delete') }}" + "/" + id,
                        data: {
                            // "_token": "{{ csrf_token() }}"
                        },
                        cache: false,
